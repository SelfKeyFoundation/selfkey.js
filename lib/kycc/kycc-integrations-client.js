...
exports.default = exports.createClient = exports.fileGet = exports.updateApplication = exports.applicationAddAttachment = exports.applicationCreateAttribute = exports.applicationCreateQuestion = exports.applicationInvalidateQuestions = exports.applicationInvalidateAttributes = exports.applicationChangeStatus = exports.applicationGet = exports.applicationsList = exports.userGet = exports.usersList = void 0;
 ...
 * ```
 */
const usersList = client => async (filters = {}, fields = null) => {
  const qs = { ...filters
  };
...
const userGet = client => async (userId, fields = null) => {
  const qs = {};
...
const applicationAddAttachment = client => async (applicationId, attachmentType, attachment) => {
  const formData = {
    type: attachmentType,
    file: {
...
exports.applicationAddAttachment = applicationAddAttachment;
